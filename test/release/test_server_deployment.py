...
def test_compose_is_lan_first_single_instance_with_persistent_data():
    ...
    assert "${AUTOSCRIPT_SERVER_IMAGE:-ghcr.io/czf39631/autoscript-hub-server:1.0.0}" in compose
    assert "AUTOSCRIPT_SERVER_IMAGE=ghcr.io/czf39631/autoscript-hub-server:1.0.0" in example_env
